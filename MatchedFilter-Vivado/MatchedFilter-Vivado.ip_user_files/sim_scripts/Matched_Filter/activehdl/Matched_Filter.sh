...
#                script (type 'Matched_Filter.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Vivado_Projects/Matched_Filter/MatchedFilter-Vivado/MatchedFilter-Vivado.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
