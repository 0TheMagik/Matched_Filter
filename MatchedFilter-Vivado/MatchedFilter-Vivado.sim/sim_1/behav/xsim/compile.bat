...
REM
REM Generated by Vivado on Sun Aug 30 14:57:54 +0700 2026
...
echo "xvlog --incr --relax -prj matched_filter_verilog_tb_vlog.prj"
call xvlog  --incr --relax -prj matched_filter_verilog_tb_vlog.prj -log xvlog.log
