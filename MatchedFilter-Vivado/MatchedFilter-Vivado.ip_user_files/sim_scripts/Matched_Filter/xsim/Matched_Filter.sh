...
#
# Script generated by Vivado on Sun Aug 30 14:56:36 +0700 2026
...
simulate()
{
  xsim Matched_Filter -key {Behavioral:sim_1:Functional:Matched_Filter} -tclbatch cmd.tcl -protoinst "protoinst_files/Matched_Filter.protoinst" -log simulate.log
}
