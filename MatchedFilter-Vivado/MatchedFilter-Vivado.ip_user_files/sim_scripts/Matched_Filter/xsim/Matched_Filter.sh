...
#
# Script generated by Vivado on Thu Aug 27 23:53:39 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Matched_Filter.sh
...
#
# Usage        : Matched_Filter.sh
#                Matched_Filter.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Matched_Filter.sh [-rerun]
#                Matched_Filter.sh [-reset_run]
#                Matched_Filter.sh [-clean]
#                Matched_Filter.sh [-reset_log]
#                Matched_Filter.sh [-help]
#
...
# script info
echo -e "Matched_Filter.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Matched_Filter.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_12 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Matched_Filter xil_defaultlib.Matched_Filter xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Matched_Filter -key {Behavioral:sim_1:Functional:Matched_Filter} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/Matched_Filter.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Matched_Filter.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Matched_Filter.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Matched_Filter.sh [-help]\n\
Usage: Matched_Filter.sh [-step]\n\
Usage: Matched_Filter.sh [-lib_map_path]\n\
Usage: Matched_Filter.sh [-rerun]\n\
Usage: Matched_Filter.sh [-reset_run]\n\
Usage: Matched_Filter.sh [-clean]\n\
Usage: Matched_Filter.sh [-reset_log]\n\
Usage: Matched_Filter.sh [-keep_index]\n\
Usage: Matched_Filter.sh [-noclean_files]\n\n\
